  ...
  .object({
    ...
    dateOfBirth: z
      .string({
        ...
        invalid_type_error:
          "'dateOfBirth' - deve ser enviado no formato string",
      })
      .min(4)
      .optional(),
  })
...
export const InsertAdressClientSchema = z
  .object({
    authorization: z
      .string({
        invalid_type_error:
    ...
    houseNumber: z
      .number({
        invalid_type_error:
          "'houseNumber' - deve ser enviado no formato string",
...
export const UpdateAdressClientSchema = z
  .object({
    authorization: z
      .string({
        invalid_type_error:
    ...
    primaryAdress: z
      .boolean({
        invalid_type_error:
          "'primaryAdress' - deve ser enviado no formato booleano",
      })
      .optional(),
    zipCode: z
      .string({
...
export const DeleteAdressClientSchema = z
  .object({
    authorization: z.string({
      required_error:
  ...
  .object({
    ...
    id: z
      .string({
        invalid_type_error: "'id' - deve ser enviado no formato string",
        required_error:
          "'id' - é um campo obrigatorio e deve ser passado pelo header",
      })
      .min(20),
  })
