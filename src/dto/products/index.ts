...
export const CreateProductsInputSchema = z.object({
    authorization: z.string({
        required_error: "'authorization' - é um campo obrigatorio, e deve ser passado no header da requisição",
    ...
    description: z.string({
        ...
        invalid_type_error: "'description' - deve ser enviado no formato string"
    }).min(2),
    price: z.number({
...
export const ProductsUpdateInputSchema = z.object({
    ...
    id: z.string({
        required_error: "'id' - é um campo obrigatorio, e deve ser passado no path parameters da requisição",
