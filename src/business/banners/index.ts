...
import { BannersInputDTO, BannersOutputDTO, DeleteBannersInputDTO, DeleteBannersOutputDTO, GetBanners, UpdateBannersInputDTO, UpdateBannersOutputDTO } from "../../dto/banners";
...
export class BannersBusiness {
    ...
    public updateBanners = async (input: UpdateBannersInputDTO): Promise<UpdateBannersOutputDTO> => {
        ...
        const Banners = new BannerModel(exists.id, title || exists.title, subTitle || exists.sub_title, cta || exists.cta, imageUrl || exists.image_url, exists.created_at, updatedAt);
    ...
    public deleteBanner = async (input: DeleteBannersInputDTO): Promise<DeleteBannersOutputDTO> => {
        ...
        const Banner = new BannerModel(exists.id, exists.title, exists.sub_title, exists.cta, exists.image_url, exists.created_at, exists.updated_at);
