...
import {
  DeleteAdressClientSchema,
  DeletePaymentSchema,
  FindClientSchema,
  InsertAdressClientSchema,
  InsertPaymentSchema,
  LoginClientSchema,
  SignupClientInputDTO,
  SignupClientOutputDTO,
  SignupClientSchema,
  UpdateAdressClientSchema,
  deleteClientSchema,
  updateClientSchema,
} from "../../dto/client";
...
export class ClientController {
  constructor(private readonly clientBusiness: ClientBusiness) {}
  ...
  public Signup = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const output: SignupClientOutputDTO =
        await this.clientBusiness.signup(input);
